...
![image-20211211082918357](04_download.png)
...
![](Platform/OS/FreeRTOS/20220115_FreeRTOS内部机制(下)/pic/pre/01_mother_do_jobs.png)
...
![image-20210712065106008](Platform/OS/FreeRTOS/20220115_FreeRTOS内部机制(下)/pic/pre/02_program_with_rtos.png)
...
* 写队列不成功而挂起`List_t xTasksWaitingToSend;`
* 读队列不成功而挂起`List_t xTasksWaitingToReceive;`
```c
/*
...
![image-20220115084249887](01_event_group_example.png)
