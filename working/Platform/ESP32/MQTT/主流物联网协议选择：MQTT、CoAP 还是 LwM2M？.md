...
相比于 MQTT，CoAP 更加轻量、开销更低，在某些特定的设备和网络环境下更为合适。EMQX 以及部分公有云物联网平台都提供提供了 CoAP 接入能力，请参考 MQTT 和 CoAP 在 EMQX 世界的一次「约会」 。
