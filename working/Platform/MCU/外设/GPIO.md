...
| 场景     | 单向通信                      | **双向通信**                               |
| 电平转换   | ×                         | √                                      |
| 功耗     | 高电平功耗较大（P-MOS消耗）          | 上拉电阻                                   |
| 电流驱动能力 | 能驱动较大负载（数字信号处理、PWM、LED驱动） | 仅能驱动**较小**负载，需外部上拉电阻（I2C等多设备通过同一信号线通信） |
### 推挽输出
...
#### 高阻态
核心特征是“断开”电路，它**不会主动提供电流或电压**，而是让电路与外部设备“透明”连接，通常在多设备**共享总线**或信号线时使用，以避免冲突或干扰。
